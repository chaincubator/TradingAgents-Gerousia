...
def create_fred_analyst(llm, toolkit):
    def fred_analyst_node(state):
        ...
        system_message = (
            ...
            "- What do market-implied breakevens signal about future inflation expectations? "
            "(5Y and 10Y breakeven rates)\n"
            "- Are real yields (TIPS) high? Rising real yields are a direct headwind for "
            ...
            "## Output\n"
            "1. Macro regime classification: Growth × Inflation × Labor × Liquidity\n"
